# Face_recognition_attendance_system_streamlit
...
4. when using anaconda navigator and you search for the face_recogniton package 
you can just create the environment and then just run this command on vscode terminal to install it using this command:
