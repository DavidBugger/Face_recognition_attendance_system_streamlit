...
with st.expander("Create New Attendence Sheet"):
    ...
    if st.button("Create New Attendence Sheet"):
        ...
        df.to_csv("/Users/mac/Downloads/Attendance-System-Project-main/Attendance" + sheet+ ".csv", index=False)
...
path = "/Users/mac/Downloads/Attendance-System-Project-main/Attendance/Manual/"
