...
with st.container():
    ...
    with c2:
        ...
        if img_file_buffer is not None:
            ...
            face_cascade = cv2.CascadeClassifier(
                '/Users/mac/Downloads/Attendance-System-Project-main/haarcascade_frontalface_default.xml')
    ...
    with c1:
        if st.button("Save Student"):
            if filled:
                path = "/Users/mac/Downloads/Attendance-System-Project-main/Dataset"+name+".jpg"
                ...
                df.to_csv(
                    "/Users/mac/Downloads/Attendance-System-Project-main/Encodings/encodings.csv", index=False)
