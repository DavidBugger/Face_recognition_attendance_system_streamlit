...
saved_df = pd.read_csv(
    "/Users/mac/Downloads/Attendance-System-Project-main/Encodings/encodings.csv")
...
path = "/Users/mac/Downloads/Attendance-System-Project-main/Attendence/With_Camera"
...
with st.expander("Create New Attendence Sheet"):
    ...
    if st.button("Create New Attendence Sheet"):
        ...
        df.to_csv("/Users/mac/Downloads/Attendance-System-Project-main/Attendence/With_Camera" +
...
name_of_attendance_sheet = ""
file_path = "/Users/mac/Downloads/Attendance-System-Project-main/Attendance/With_Camera/Sheet1 01-03-2023.csv"
df = pd.read_csv(file_path) 
# name_of_attendance_sheet = ""
# if name_of_attendance_sheet is None:
#     raise ValueError("Invalid attendance sheet name. Please provide a valid name.")
...
while start:
    ...
    if face_names:
        for face_loc, name in zip(face_locations, face_names):
            ...
            with open("/Users/mac/Downloads/Attendance-System-Project-main/Attendance/With_Camera" , name_of_attendence_sheet+".csv", 'a') as csv_file:
